	...
	<form name="newProduct" action="ProductUpdate.do " class="form-horizontal" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3" id="productrealcolor">
				<input type="checkbox" name="productcolor" value="빨강">빨강
				<input type="checkbox" name="productcolor" value="주황">주황
				<input type="checkbox" name="productcolor" value="노랑">노랑
				<input type="checkbox" name="productcolor" value="초록">초록
				<input type="checkbox" name="productcolor" value="파랑">파랑
				<input type="checkbox" name="productcolor" value="남색">남색
				<input type="checkbox" name="productcolor" value="보라색">보라색
				<input type="checkbox" name="productcolor" value="하얀색">하얀색
				<input type="checkbox" name="productcolor" value="검정색">검정색
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-2">상품 설명란입니다.</label>
			<div class="col-sm-3">
				<textarea name="contents" cols="50" rows="2" >${productBean.contents }</textarea>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<textarea name="d_contents" id="summernote">${productBean.d_contents }</textarea>
			</div>
		</div>
