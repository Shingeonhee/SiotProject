...
<body>
	<div class="formBox">
		<form action="UserJoinForm.do" id="joinForm" method="GET" name="my_form">
			<div>
				<h2>Terms &amp; Policy</h2>
				<div id="joinchecka">
					<input type="checkBox" name="check" id="check" onclick="check_all()">
				...
				<div id="jointext">
					<textarea style="width: 1250px;height: 200px;overflow-y: scroll; resize: none;" readonly>
제1조 목적
...
<!-- 				<input type="button" value="가입하기" id="join" class="log"> -->
				<input type="submit" value="가입하기" id="join" style="height: 39px;width: 99px;background: #4f4f4f;color: #fff;margin: 10px 0;">
				<input type="reset" value="취소" id="cancel" style="height: 39px;width: 65px;color: rgba(79,79,79,0.3);">
			</div>
		</form>
	</div>
<%@ include file="../include/footer.jsp"%>
	...
	<script>
	function check_all(){
		for(i=0; i < my_form.check.length;i++){
			my_form.check[i].checked = true;
		}
	}
