...
<body>
	...
	<form method="POST" action="ProductQnaWrite.do" id="QnaWriteForm" enctype="multipart/form-data">
	<div class="writeHeader">
		<div class="writerHeaderInner">
			...
			<div class="writeBtn">
				...
				<input type="hidden" value="${loggedUserInfo.password}" name="userPassword" >
			</div>
		</div>
	</div>
	<div class="writeBox">
